        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="mt-6 flex gap-3">
              <a href="#" className="text-white/40 transition-colors duration-300 hover:text-cta" aria-label="Telegram">
              ...
              <a href="#" className="text-white/40 transition-colors duration-300 hover:text-cta" aria-label="WhatsApp">
              ...
              <a href="#" className="text-white/40 transition-colors duration-300 hover:text-cta" aria-label="VK">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-cta">Каталог</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-cta">Услуги</h4>
            <ul className="mt-4 space-y-3">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-cta">Контакты</h4>
            <ul className="mt-4 space-y-4">
              <li className="flex items-start gap-3 text-sm text-white/50">
                <MapPin className="mt-0.5 h-4 w-4 flex-shrink-0 text-cta" />
                <span>г. Москва, ул. Каменная, д. 15, складской комплекс «Гранит»</span>
              </li>
              <li className="flex items-center gap-3 text-sm">
                <Phone className="h-4 w-4 flex-shrink-0 text-cta" />
                <a href="tel:+74951234567" className="text-white/50 transition-colors duration-300 hover:text-white">+7 (495) 123-45-67</a>
              </li>
              <li className="flex items-center gap-3 text-sm">
                <Mail className="h-4 w-4 flex-shrink-0 text-cta" />
                <a href="mailto:info@kamen.ru" className="text-white/50 transition-colors duration-300 hover:text-white">info@kamen.ru</a>
              </li>
              <li className="flex items-center gap-3 text-sm">
                <Phone className="h-4 w-4 flex-shrink-0 text-cta" />
                <a href="tel:+78001234567" className="text-white/50 transition-colors duration-300 hover:text-white">8 (800) 123-45-67</a>
              </li>
            </ul>
          </div>
        </div>
