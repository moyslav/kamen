...
function pexel(id: number): string {
  return `${PEXELS}/${id}/pexels-photo-${id}.jpeg?auto=compress&cs=tinysrgb&w=800`
}

export const categories: Category[] = [
  { slug: 'mramor', name: 'Мрамор', description: 'Классический натуральный камень для интерьеров', image: pexel(8383698) },
  { slug: 'granit', name: 'Гранит', description: 'Прочный камень для фасадов и полов', image: pexel(4144179) },
  { slug: 'kvarcit', name: 'Кварцит', description: 'Твёрдый камень с уникальным рисунком', image: pexel(4035713) },
  { slug: 'oniks', name: 'Оникс', description: 'Полупрозрачный камень с подсветкой', image: pexel(462305) },
  { slug: 'travertin', name: 'Травертин', description: 'По́ристый камень для тёплых тонов', image: pexel(1029619) },
  { slug: 'iskusstvennyy-kamen', name: 'Искусственный камень', description: 'Кварцевый агломерат и керамогранит', image: pexel(869258) },
]
...
export const products: Product[] = [
  {
    ...
    images: productImages(8383698), price: 'от 12 000 ₽/м²',
  ...
  },
  {
    ...
    images: productImages(4144179), price: 'от 9 500 ₽/м²',
  ...
  },
  {
    ...
    images: productImages(4035713), price: 'от 6 500 ₽/м²',
  ...
  },
  {
    ...
    images: productImages(462305), price: 'от 7 500 ₽/м²',
  ...
  },
  {
    ...
    images: productImages(1029619), price: 'от 18 000 ₽/м²',
  ...
  },
  {
    ...
    images: productImages(869258), price: 'от 11 000 ₽/м²',
  ...
  },
  {
    ...
    images: productImages(1933239), price: 'от 8 500 ₽/м²',
  ...
  },
  {
    ...
    images: productImages(4252777), price: 'от 6 500 ₽/м²',
  ...
  },
  {
    ...
    images: productImages(8204774), price: 'от 25 000 ₽/м²',
  ...
  },
  {
    ...
    images: productImages(1974508), price: 'от 7 000 ₽/м²',
...
export const services: Service[] = [
  { slug: 'rezka', title: 'Резка камня', description: 'Гидроабразивная резка любой сложности. Точность до ±1 мм.', priceFrom: '1 500', image: pexel(8383698) },
  { slug: 'polirovka', title: 'Полировка камня', description: 'Восстановление блеска и обработка кромки любой сложности.', priceFrom: '1 200', image: pexel(4144179) },
  { slug: 'montazh', title: 'Монтаж камня', description: 'Профессиональная укладка с гарантией до 3 лет.', priceFrom: '3 500', image: pexel(4035713) },
  { slug: 'izgotovlenie-izdeliy', title: 'Изготовление изделий', description: 'Столешницы, подоконники, барные стойки, ступени — под заказ.', priceFrom: '5 000', image: pexel(462305) },
  { slug: 'dostavka', title: 'Доставка камня', description: 'По Москве и всей России. Собственный транспорт до 300 км от МКАД.', priceFrom: '2 000', image: pexel(1029619) },
]
